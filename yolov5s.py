...
class Yolov5s(M.Module):
    ...
    def forward(self , x):
      ...
      #output
      p7 = M.Conv2d(128, (self.num_class + 5) * self.anchors_per_location, ksize=1)(p7) # padding=0
      p7 = Reshape([self.image_shape[0]//8, self.image_shape[1]//8, self.anchors_per_location, self.num_class + 5])(p7)
      p8 = M.Conv2d(256, (self.num_class + 5) * self.anchors_per_location, ksize=1)(p8)
      p8 = Reshape([self.image_shape[0]//16, self.image_shape[1]//16, self.anchors_per_location, self.num_class + 5])(p8)
      p9 = M.Conv2d(512, (self.num_class + 5) * self.anchors_per_location, ksize=1)(p9)

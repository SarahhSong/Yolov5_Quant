...
class CoCoDataGenrator:
    def __init__(self,
        ...
        self.coco_data_file = coco_data_file
    ...
    def _load_image(self, image_id):
        ...
        img_local_file = os.path.join(self.coco_data_file, img_local_file)
...
if __name__ == "__main__":
    ...
    file = "/mnt/e/数据集/COCO/annotations/annotations_trainval2017/annotations/instances_val2017.json"
    # file = "./yanhua/annotations.json"
    coco = CoCoDataGenrator(
        coco_annotation_file=file,
        coco_data_file = '/mnt/e/数据集/COCO/images/val2017/val2017',
        train_img_nums=30,
        include_mask=True,
        include_keypoint=False,
